...
class UpdateDatabase extends StatefulWidget {
  var updateid = "";
  var title = "";
  UpdateDatabase({required this.updateid, required this.title});
                    ...
                    children: [
                      ...
                      DropdownButton(
                        ...
                        items: [
                          ...
                          DropdownMenuItem(
                              child: Text("investment"), value: "investment"),
                          DropdownMenuItem(
                  ...
                  Center(
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Databasehedler obj = new Databasehedler();
                        var status = await obj.updatenotes(type, category,
                            title, remark, amount, date, widget.updateid);
                        if(status==1)
                          {
